...
<body>
  <div class="box">
    ...
    <a href="index.php" class="btn btn-outline-secondary w-100 mb-2">Voltar para a loja</a>
...
<body>
  ...
  <div class="login-box">
    ...
    <form action="cadastro.php" method="POST">
      ...
      <a href="index.php" class="btn btn-outline-secondary w-100 mt-2">Voltar para a loja</a>
