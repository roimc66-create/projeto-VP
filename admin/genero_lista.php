...
<div class="container">
    ...
    <div class="card-custom">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title">Lista de Gêneros</h2>

            <a href="genero_insere.php" class="btn btn-success btn-lg btn-custom shadow-sm">
                ➕ Adicionar Novo
            </a>
        </div>
        ...
        <div class="table-responsive mt-4">
            <table class="table table-hover align-middle">
                ...
                <?php do { ?>
                    <tr>
                        <td><strong><?php echo $row['id_genero']; ?></strong></td>
                        <td><?php echo $row['nome_genero']; ?></td>

                        <td class="text-center">
                            <a
                                href="genero_atualiza.php?id_genero=<?php echo $row['id_genero']; ?>"
                            ...
                            <button
                                ...
                                data-id="<?php echo $row['id_genero']; ?>"
                                data-nome="<?php echo $row['nome_genero']; ?>">
                                🗑 Excluir
                            </button>
                        </td>
                    </tr>
...
document.querySelectorAll('.delete').forEach(botao => {
    botao.addEventListener('click', function () {
        ...
        document.querySelector('.delete-yes')
            .setAttribute('href', 'genero_exclui.php?id_genero=' + id);
